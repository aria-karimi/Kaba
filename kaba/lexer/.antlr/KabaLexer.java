...
public class KabaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"BOK", "TORBASI", "BOKU", "KAT", "SÖK", "ÇAK", "YAR", "AYNI", "TERSI", 
			"KOYMUŞ", "KOYMAMIŞ", "VE", "YA", "SIKTIYSE", "SIKMEDIYSE", "SIKERKEN", 
			"SALLAYARAK", "ÇÖK", "TÜKÜR", "DENESENE", "SIÇARSA", "REZALET", "PATLAT", 
			"SOK", "ŞÖYLE", "BÖYLE", "HADI", "SIKTIR", "DEMIŞ", "DEMEMIŞ", "VIRGUL", 
			"AMK", "AMQ", "AQ", "AMIK", "AMINAKOYUM", "DÜZ", "SULU", "NET", "SAÇMA", 
			"SIKER", "SIKMEZ", "STRING_BLOCK", "SUFFIX", "ID", "TURKISH_LETTER", 
			"WS", "UNRECOGNIZED"
		};
	}
	...
	public KabaLexer(CharStream input) {
		super(input);
